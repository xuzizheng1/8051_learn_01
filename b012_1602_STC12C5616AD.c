...
void main (void){
	...
	UART_init();//串口初始程序
	Read_init(0);//ADC初始化
	P1M0 = 0x01; //P1.7~1.0：0000 0001（高阻）//注意：更改ADC通道时须同时将对应的IO接口修改为高阻输入。
	P1M1 = 0x00; //P1.7~1.0：0000 0000（将 P1.0 设置为高阻）
...
//		print(0x40,"www.DoYoung.net"); //在第一行第一位处从左向右打印doyoung.net字符串
		...
		print2(0x4a, R/100 + 0x30);
		print2(0x4b, (R%100)/10 + 0x30);
		print2(0x4c, R%10 + 0x30);
